      ...
      >
        ...
        <div className="max-w-sm mx-auto mb-6">
          <Input
            ...
            className="bg-foreground/5 border-secondary/30 text-white placeholder:text-white/50 placeholder:font-sans placeholder:text-base focus-visible:ring-secondary text-center font-signature text-7xl h-24 leading-none py-1"
          />
        </div>

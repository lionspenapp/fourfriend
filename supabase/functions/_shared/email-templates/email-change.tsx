...
export const EmailChangeEmail = ({ email, newEmail, confirmationUrl }: EmailChangeEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your email change for Lion's Pen</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          A request has been made to change your email address from <strong>{email}</strong> to <strong>{newEmail}</strong>.
        </Text>

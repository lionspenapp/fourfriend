...
export const MagicLinkEmail = ({ confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your sign-in link for Lion's Pen</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Click the button below to step into your Inner Scriptorium. This link will expire shortly.
        </Text>
        <div style={buttonWrap}>
          <Button style={button} href={confirmationUrl}>Sign In</Button>
        </div>
        <Text style={footer}>
          If you didn't request this link, you may safely ignore this message.
        </Text>
